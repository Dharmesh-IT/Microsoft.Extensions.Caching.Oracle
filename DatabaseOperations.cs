...
public class DatabaseOperations : IDatabaseOperations
{
    ...
    public void SetCacheItem(string key, byte[] value, DistributedCacheEntryOptions options)
    {
        ...
        var utcNow = DateTime.Now; //SystemClock.UtcNow;
    ...
    public void DeleteExpiredCacheItems()
    {
        ...
        command.Parameters.AddWithValue("UtcNow", OracleDbType.TimeStampTZ, DateTime.Now);
    ...
    private byte[]? InternalGetCacheItem(string key)
    {
        ...
        command.Parameters
            .AddCacheItemId(key)
            .AddWithValue("UtcNow", OracleDbType.TimeStampTZ, DateTime.Now);
